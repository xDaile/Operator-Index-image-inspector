...
@patch("OIIInspector.oii_inspector_calls.get_bundle_for_channel", return_value="Client-response")
@patch("OIIInspector.oii_inspector_calls.json.dump")
...
@patch("OIIInspector.oii_inspector_calls.get_bundle_that_replaces", return_value="Client-response")
@patch("OIIInspector.oii_inspector_calls.json.dump")
...
@patch("OIIInspector.oii_inspector_calls.get_default_bundle_that_provides", return_value="Client-response")
@patch("OIIInspector.oii_inspector_calls.json.dump")
